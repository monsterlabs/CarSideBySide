...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    AFIncrementalStore *incrementalStore = (AFIncrementalStore *)[_persistentStoreCoordinator addPersistentStoreWithType:[CarSideBySideIncrementalStore type] configuration:nil URL:nil options:nil error:nil];
